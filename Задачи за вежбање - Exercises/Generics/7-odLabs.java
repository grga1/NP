...
class ComplexNumber<T extends Number,K extends  Number> implements Comparable<ComplexNumber<?,?>>{
    private final T real;
    private final K imaginary;

    public ComplexNumber(T real, K imaginary) {
        this.real = real;
